...
namespace PetaPoco
{
    ...
    public class OutputColumnAttribute : ColumnAttribute
    {
        ...
        public OutputColumnAttribute(OutputColumnMode modes, bool isResultColumn)
        {
        ...
        public OutputColumnAttribute(string name) : base(name) { }
    ...
    public class Database : IDisposable
    {
        ...
        public bool EnableOutputColumns { get; set; }
        ...
        public object Insert(string tableName, string primaryKeyName, string[] outputColumns, object poco)
        {
            return Insert(tableName, primaryKeyName, true, outputColumns, poco);
        }

        // Insert a poco into a table.  If the poco has a property with the same name 
        // as the primary key the id of the new record is assigned to it.  Either way,
        // the new id is returned.
        public object Insert(string tableName, string primaryKeyName, bool autoIncrement, string[] outputColumns, object poco)
        {
            try
            {
                OpenSharedConnection();
        ...
        public object Insert(object poco)
        {
            ...
            return Insert(pd.TableInfo.TableName, pd.TableInfo.PrimaryKey, pd.TableInfo.AutoIncrement, pd.OutputColumnsOnInsert, poco);
        }
        ...
        public class PocoColumn
        {
            ...
            public OutputColumnMode OutputColumnMode;
        ...
        public class PocoData
        {
            ...
            public PocoData(Type t)
            {
                ...
                foreach (var pi in t.GetProperties())
                {
                    ...
                    pc.PropertyInfo = pi;
                    pc.OutputColumnMode = OutputColumnMode.None;
                    ...
                    foreach (var cAtt in ColAttrs)
                    {
                        if ((cAtt as ResultColumnAttribute) != null)
                        {
                            pc.ResultColumn = true;
                            continue;
                        }
                        OutputColumnAttribute outputAtt = cAtt as OutputColumnAttribute;
                        if (outputAtt != null)
                        {
                            pc.OutputColumnMode = outputAtt.OutputColumnMode;
                            continue;
                            //pc.ResultColumn = outputAtt.IsResultColumn;
                        }
                    }
                ...
                OutputColumnsOnUpdate = (from c in Columns where c.Value.OutputColumnMode.HasFlag(OutputColumnMode.Update) select c.Key).ToArray();
                // Build column list for automatic output clause on UPDATE
                OutputColumnsOnUpdate = (from c in Columns where c.Value.OutputColumnMode.HasFlag(OutputColumnMode.Insert) select c.Key).ToArray();
            ...
            public string[] OutputColumnsOnUpdate { get; private set; }
            public string[] OutputColumnsOnInsert { get; private set; }
